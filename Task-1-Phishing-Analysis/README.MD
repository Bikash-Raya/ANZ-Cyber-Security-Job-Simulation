...
You are expected to report your findings on each email so that we can either block or release these emails to users.
...
👉 [Download Task 1 Report](./Task-1-Phishing-Analysis/Task1-Report.docx)
